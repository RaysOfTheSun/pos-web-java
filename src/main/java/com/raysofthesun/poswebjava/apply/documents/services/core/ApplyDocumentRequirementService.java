...
public abstract class ApplyDocumentRequirementService implements PosWebService {
    private final PosConfig posConfig;

    public ApplyDocumentRequirementService(PosConfig posConfig) {
    ...
    private List<PosDocumentRequirement> getDocumentReqsForApplication(ApplicationMeta applicationMeta) {

...
//    }
//
//    protected Mono<Application> createApplicationWithRequest(ApplicationCreationRequest request,
//                                                             String agentId,
//                                                             Market market) {
//        return getInsuredsForApplicationByRequest(request, agentId, market)
//                .collectMap((Insured::getId))
//                .map((insuredIdMap -> {
//
...
//    }
//
//    protected Flux<Insured> getInsuredsForApplicationByRequest(ApplicationCreationRequest request,
//                                                               String agentId,
//                                                               Market market) {
//        return getCustomerIdsFromRequest(request)
//                .collectList()
//                .flatMap((customerIds) -> customerApi.getCustomersByIdAndAgentId(agentId, customerIds, market).collectList())
